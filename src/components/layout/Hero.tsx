...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative flex items-center justify-center bg-film-darker-blue">
      <div className="container mx-auto px-4 md:px-6 relative z-10 py-12 md:py-16 lg:py-20 flex flex-col items-center justify-center text-center">
        <h1 
          ref={titleRef}
        ...
        <div 
          ...
          className="mt-6 md:mt-8 space-x-4 opacity-0 transition-opacity duration-700 delay-1000"
        >
          <button 
